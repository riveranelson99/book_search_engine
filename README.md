...
This Portfolio Piece is graded based on the following criteria:
...
* Satisfies all of the preceding acceptance criteria plus the following:
	...
	* Include schema settings for resolvers and typeDefs as outlined In the Portfolio Piece instructions.
...
* Application resembles the mock-up functionality provided In the Portfolio Piece instructions.
